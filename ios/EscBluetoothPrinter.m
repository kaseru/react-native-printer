...
static int WIDTH_80 = 576;
static Byte ESC[] = {0x1b};
//NSInteger ESC = 0x1b;
static Byte ESC_FS[] = {0x1c};
//NSInteger FS = 0x1C;
static Byte ESC_GS[] = {0x1D};
static Byte US[] = {0x1F};
static Byte DLE[] = {0x10};
static Byte DC4[] = {0x14};
static Byte DC1[] = {0x11};
static Byte SP[] = {0x20};
static Byte NL[] = {0x0A};
static Byte FF[] = {0x0C};
static Byte PIECE[] = {0xFF};
static Byte NUL[] =  {0x00};
static Byte SIGN[] = {0x21};//!
static Byte T[] = {0x74};//t
static Byte AND[] ={0x26}; //&
static Byte M[] = {0x4d};//M
static Byte V[] = {0x56};//V
static Byte A[] = {0x61};//a
static Byte E[] = {0x45};//E
static Byte G[] = {0x47};//G

static RCTPromiseResolveBlock pendingResolve;
static RCTPromiseRejectBlock pendingReject;
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    if(BluetoothPrinter.isConnected){
        ...
        [BluetoothPrinter writeValue:data withDelegate:self];
    }else{
                  ...
                  rejecter:(RCTPromiseRejectBlock) reject)
{
    ...
    pendingReject = reject;
    pendingResolve = resolve;
    [BluetoothPrinter writeValue:toPrint withDelegate:self];
}
//  L:1,
//M:0,
//Q:3,
...
// Feed giấy (ESC d n)
RCT_EXPORT_METHOD(printAndFeed:(NSInteger)lines
                  resolver:(RCTPromiseResolveBlock)resolve
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    if(BluetoothPrinter.isConnected){
        unsigned char cmd[3] = {0x1B, 0x64, (unsigned char)lines};
        [BluetoothPrinter writeValue:[NSData dataWithBytes:cmd length:3] withDelegate:nil];
        resolve(@(YES));
    }else{
        reject(@"COMMAND_NOT_SEND",@"COMMAND_NOT_SEND",nil);
    }
...
// Mở ngăn kéo (pulse pin 0 or 2, thường pin 0)
RCT_EXPORT_METHOD(openDrawer:(NSInteger)pin
                  ...
                  rejecter:(RCTPromiseRejectBlock)reject)
{
    if ([BluetoothPrinter isConnected]) {
        ...
        [BluetoothPrinter writeValue:[NSData dataWithBytes:cmd length:4] withDelegate:nil];
        resolve(@(YES));
    } else {
